...
// var result=function palindrome(){
//     str=prompt("enter string")
//     senestive=confirm("consider case sensitivity")
//         if(senestive){
...
//                 if(str.toLowerCase() ==str2.reverse().join()){
//                     console.log("palindrome")
//                 }
//                 else{
//                     console.log("not palindrome");
...
var num;
var result=function enter(){
str = prompt("enter string");
console.log(str.length);

latter = prompt("enter latter");
